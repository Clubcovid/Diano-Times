                        ...
                        <CardContent className="space-y-6">
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <a href="tel:+254707070560" className="text-muted-foreground hover:text-primary">+254707070560</a>
                                </div>
                            </div>
                             <div className="flex items-center gap-4">
                                <div className="flex gap-4 text-primary">
                                    <a href="#" className="hover:text-foreground" aria-label="Instagram"><Instagram /></a>
                                    <a href="https://x.com/TalkofNations?t=Z7MSDp3fplIqkuqYzTrxJw&s=09" target="_blank" rel="noopener noreferrer" className="hover:text-foreground" aria-label="Twitter"><Twitter /></a>
                                    <a href="#" className="hover:text-foreground" aria-label="Facebook"><Facebook /></a>
                                </div>
                            </div>
                        </CardContent>
                    </Card>
