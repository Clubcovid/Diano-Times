      ...
      <header className="sticky top-0 z-50 bg-background/95 backdrop-blur-sm border-b">
        <div className="container mx-auto px-4 md:px-6 h-20 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-6 text-sm font-medium">
            ...
            <Link href="/fashion" className="text-foreground hover:text-primary transition-colors">Fashion</Link>
      ...
      <main className="flex-1">
        <div className="container mx-auto px-4 md:px-6 py-12">
            <div className="text-center mb-12">
                <h1 className="text-4xl md:text-5xl font-bold font-headline text-primary">Fashion</h1>
                <p className="text-lg text-muted-foreground mt-2">Latest trends and styles</p>
            </div>
            <div className="mb-8">
                <Suspense>
                    <Tags />
