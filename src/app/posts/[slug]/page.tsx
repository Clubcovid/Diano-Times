      ...
      <main className="flex-1 container mx-auto px-4 md:px-6 py-12">
        <div className="grid lg:grid-cols-3 gap-12">
            ...
            <div className="relative aspect-video mb-8 rounded-lg overflow-hidden shadow-lg bg-muted">
                {post.coverImage ? (
                    <Image src={post.coverImage} alt={post.title} fill className="object-cover" priority sizes="(max-width: 1024px) 100vw, 67vw" />
                ) : (
            ...
            <aside className="lg:col-span-1 space-y-8 lg:sticky top-28 h-fit">
                <Card>
                    <CardHeader><CardTitle className="font-headline">Share This Article</CardTitle></CardHeader>
                    <CardContent><ShareButtons title={post.title} slug={post.slug} /></CardContent>
                </Card>
                {filteredRelatedPosts.length > 0 && (
                     <Card>
                        <CardHeader><CardTitle className="font-headline">Related Articles</CardTitle></CardHeader>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <nav className="flex flex-wrap justify-center gap-x-6 gap-y-2 text-sm text-center">
             ...
             <div className="flex gap-4">
                ...
                <a href="https://x.com/TalkofNations" className="hover:text-primary"><Twitter /></a>
